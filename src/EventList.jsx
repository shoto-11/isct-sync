...
const s = {
  ...
  cardImg: { width:"100%", height: window.innerWidth > 768 ? 158 : 90, objectFit:"cover", display:"block" },
  cardThumb: { width:"100%", height: window.innerWidth > 768 ? 158 : 90, display:"flex", alignItems:"center", justifyContent:"center" },
